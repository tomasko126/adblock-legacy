...
(function() {
    ...
    if (S.Env = function() {
            ...
            return ie(e, t), e.prototype.url = function() {
                ...
                window.addEventListener("load", function() {
                    ...
                    if (o = window.location.href, r = JSON.stringify({
                        ...
                        }), S.AuthDriver.BrowserBase.cleanupLocation(), n = window.opener, window.parent !== window.top && (n || (n = window.parent)), n) {
                        try {
            ...
            return ie(e, t), e.prototype.doAuthorize = function(t, e, r, n) {
                ...
                return o = null, i = function(t, r) {
                    var a;
                    if ((!r || !r.tab || r.tab.url.substring(0, s.receiverUrl.length) === s.receiverUrl) && t.dropbox_oauth_receiver_href) return a = t.dropbox_oauth_receiver_href, s.locationStateParam(a) === e ? (e = !1, o && chrome.tabs.remove(o.id), chrome.extension.onRequest.removeListener(i), n(S.Util.Oauth.queryParamsFromUrl(a))) : void 0
                }, chrome.extension.onRequest.addListener(i), chrome.tabs.create({
                    url: t
                }, function(t) {
                    return o = t
                })
            ...
            function t(t) {
                ...
                })) : this._tlsOptions = null, this._fs = S.Env.require("fs"), this._http = S.Env.require("http"), this._https = S.Env.require("https"), this._open = S.Env.require("open"), this._callbacks = {}, this._nodeUrl = S.Env.require("url"), this.createApp()
            }
            return t.prototype.authType = function() {
                return "code"
            }, t.prototype.url = function() {
            ...
            return t.prototype.onXhr = null, t.prototype.onError = null, t.prototype.onAuthStepChange = null, t.prototype.authDriver = function(t) {
                ...
                if (this.authStep === h.ERROR) chrome.extension.sendRequest({
                    message: "clienterror"
                });
                return o = function() {
                ...
                return e ? (n = {
                    ...
                    offset: 0
                }, i = new S.Util.Xhr("POST", this._urls.chunkedUpload), i.setBody(t).setParams(n).signWithOauth(this._oauth), this._dispatchXhr(i, function(t, e) {
                ...
                return n || "function" != typeof r || (n = r, r = null), i = {
                    upload_id: e.tag
                }, r && (r.lastVersionTag ? i.parent_rev = r.lastVersionTag : (r.parentRev || r.parent_rev) && (i.parent_rev = r.parentRev || r.parent_rev), r.noOverwrite && (i.overwrite = "false")), o = new S.Util.Xhr("POST", "" + this._urls.commitChunkedUpload + "/" + this._urlEncodePath(t)), o.setParams(i).signWithOauth(this._oauth), this._dispatchXhr(o, function(t, e) {
                    return n ? n(t, S.File.Stat.parse(e)) : void 0
                })
                ...
                return r || "function" != typeof e || (r = e, e = null), i = e && (e["long"] || e.longUrl || e.downloadHack) ? {
                    short_url: "false"
                } : {}, t = this._urlEncodePath(t), o = "" + this._urls.shares + "/" + t, n = !1, s = !1, e && (e.downloadHack ? (n = !0, s = !0) : e.download && (n = !0, o = "" + this._urls.media + "/" + t)), a = new S.Util.Xhr("POST", o).setParams(i).signWithOauth(this._oauth), this._dispatchXhr(a, function(t, e) {
                ...
                var n;
                return n = new S.Util.Xhr("POST", "" + this._urls.restore + "/" + this._urlEncodePath(t)), n.setParams({
                    rev: e
                ...
                return n || "function" != typeof r || (n = r, r = null), o = {
                    query: e
                }, i = !1, r && (null != r.limit && (o.file_limit = r.limit), (r.removed || r.deleted) && (o.include_deleted = !0), r.httpCache && (i = !0)), s = new S.Util.Xhr("GET", "" + this._urls.search + "/" + this._urlEncodePath(t)), s.setParams(o).signWithOauth(this._oauth, i), this._dispatchXhr(s, function(t, e) {
                    var r, i;
                    return i = e ? function() {
                        var t, n, i;
                ...
                return e || "function" != typeof t || (e = t, t = null), r = t ? t.cursorTag ? {
                    ...
                    cursor: t
                } : {}, n = new S.Util.Xhr("POST", this._urls.delta), n.setParams(r).signWithOauth(this._oauth), this._dispatchXhr(n, function(t, r) {
                ...
                return r || "function" != typeof e || (r = e, e = null), n = t.cursorTag ? {
                    ...
                    cursor: t
                }, e && "timeout" in e && (n.timeout = e.timeout), i = new S.Util.Xhr("GET", this._urls.longpollDelta), i.setParams(n), this._dispatchXhr(i, function(t, e) {
                    var n;
                ...
                var r;
                return r = new S.Util.Xhr("POST", this._urls.fileopsCreateFolder), r.setParams({
                    root: "auto",
                ...
                var r;
                return r = new S.Util.Xhr("POST", this._urls.fileopsDelete), r.setParams({
                    root: "auto",
                    path: this._normalizePath(t)
                }).signWithOauth(this._oauth), this._dispatchXhr(r, function(t, r) {
                    return e ? e(t, S.File.Stat.parse(r)) : void 0
                ...
                }, t instanceof S.File.CopyReference ? n.from_copy_ref = t.tag : n.from_path = this._normalizePath(t), i = new S.Util.Xhr("POST", this._urls.fileopsCopy), i.setParams(n).signWithOauth(this._oauth), this._dispatchXhr(i, function(t, e) {
                    return r ? r(t, S.File.Stat.parse(e)) : void 0
                })
            }, t.prototype.move = function(t, e, r) {
                var n;
                return n = new S.Util.Xhr("POST", this._urls.fileopsMove), n.setParams({
                    root: "auto",
                ...
                var r;
                return e || "function" != typeof t || (e = t, t = this._oauth.credentials().key), r = new S.Util.Xhr("GET", this._urls.appsInfo), r.setParams({
                    app_key: t
                ...
                var n;
                return "object" == typeof t && "uid" in t && (t = t.uid), r || "function" != typeof e ? "object" == typeof e && "key" in e && (e = e.key) : (r = e, e = this._oauth.credentials().key), n = new S.Util.Xhr("GET", this._urls.appsCheckDeveloper), n.setParams({
                    app_key: e,
                    uid: t
                ...
                var n;
                return r || "function" != typeof e ? "object" == typeof e && "key" in e && (e = e.key) : (r = e, e = this._oauth.credentials().key), n = new S.Util.Xhr("GET", this._urls.appsCheckRedirectUri), n.setParams({
                    app_key: e,
                    redirect_uri: t
                }), this._dispatchXhr(n, function(t, e) {
            ...
            return t.DATASTORE_SIZE_LIMIT = 10485760, t.RECORD_COUNT_LIMIT = 1e5, t.BASE_DATASTORE_SIZE = 1e3, t.TEAM = "team", t.PUBLIC = "public", t.OWNER = "owner", t.EDITOR = "editor", t.VIEWER = "viewer", t.NONE = "none", t.prototype.recordsChanged = null, t.prototype.syncStatusChanged = null, t.int64 = function(t) {
                ...
                var r;
                return e === S.Datastore.NONE ? (this.deleteRole(t), void 0) : (this._checkShareable(), this._checkPrincipal(t), this._checkRole(e), this._checkWritable(), r = S.Datastore.int64(S.Datastore._intFromRole(e)), this.getTable(te.ACL_TID).getOrInsert(t).update({
                    role: r
                }))
            ...
            for (Z.string(t, "struct name"), Z.array(e, "fields"), f = [], p = {}, s = g = 0, y = e.length; y > g; s = ++g) {
                ...
                ne.call(d, "init") >= 0 && ne.call(d, "initFn") >= 0 && Z.fail("both 'init' and 'initFn' specified", d, "field options", "field descriptor", e), u = "initFn" in d ? d.initFn : "init" in d ? (a = d.init, function(t) {
                    ...
                    type: _,
                    initFn: u
                }, o = "undefined" != typeof G && null !== G ? new G(r) : r, f.push(o), p[c] = o
            }
            ...
            for (Z.string(t, "union name"), Z.array(e, "variants"), n = function() {
                    ...
                    return o = ee.define("" + t + "." + e, i), o.prototype.tag = function() {
                        ...
                        var i, s, a, u, l, h, c;
                        for (l = "initializer for " + t, Z.array(n, "initializer", l), Z.check(n.length === r.length + 1, "does not have length " + (r.length + 1), n, "initializer", l), Z.check(n[0] === e, "does not have tag " + e, n, "initializer", l), i = {
                                _tag: e
            ...
            ["rev", Z.nullable(Z.uint), {
                init: null
            }],
            ["role", Z.nullable(Z.uint), {
                init: null
            }],
            ["notfound", Z.nullable(Z.string), {
                init: null
            }]
            ...
            ["conflict", Z.nullable(Z.string), {
                init: null
            }],
            ["notfound", Z.nullable(Z.string), {
                init: null
            }],
            ["access_denied", Z.nullable(Z.string), {
                init: null
            }]
        ]), x = ee.define("GetDeltasResponse", [
            ["deltas", Z.nullable(Z.arrayOf(D)), {
                init: null
            }],
            ["role", Z.nullable(Z.uint), {
                init: null
            ...
            ["get_deltas", Z.nullable(e), {
                init: null
            }],
            ["list_datastores", Z.nullable(k), {
                init: null
            }]
        ]), r = function() {
            function t() {
            ...
            return t.fresh_managed_datastore = function(e, r, n, i, o, s, a, u) {
                ...
                var t;
                return this._update_mtime_on_change ? (t = null != this.datastore_model.query(":info", "info") ? n.from_array(["U", ":info", "info", {
                    mtime: ["P", te.toDsValue(this._clock())]
                }]) : n.from_array(["I", ":info", "info", {
            ...
            return t.prototype.get_server_rev = function() {
                ...
                var t, e;
                return Y(null == this._pending_delta, "delta pending"), t = this.unsynced_deltas.length, 0 === t || 1 === t && this._last_unsynced_delta_unfinalized ? null : (this._compact_deltas(), this._last_unsynced_delta_unfinalized && Y(this.unsynced_deltas.length > 1, "the only delta is unfinalized"), e = this.unsynced_deltas[0], this._pending_delta = new D({
                ...
                return t = function() {
                    ...
                    if (!e.cancelled) return r = te.clone(e.update_manager._handle_version_map), e.cancel_fn = e.update_manager.flob_client.await(r, e.update_manager._last_dslist_token, function(n, i) {
                        ...
                        if (null != i.get_deltas) {
                            ...
                            for (u in _)
                                if (s = _[u], null != s.notfound) e.update_manager._data_queue.push({
                                    handle: u,
                                    notfound: s.notfound
                                }), delete e.update_manager._handle_version_map[u];
                                else if (null != s.deltas) {
                                for (null != s.role && e.update_manager._data_queue.push({
                                        handle: u,
                                        role: s.role
                                    }), p = s.deltas, h = 0, c = p.length; c > h; h++) a = p[h], e.update_manager._data_queue.push({
                                    handle: u,
                                    delta: a
                                });
            ...
            return l = function(t) {
                ...
                return null == r && (r = null), "sum" === this.rule_name && "P" === t.tag() && "P" === e.tag() && (null == r && (r = {
                    I: "0"
                }), _(r) && _(t.value) && _(e.value)) ? (o = a(r, t.value, e.value), n = i = A.from_array(["P", o]), [n, i, e.value]) : (s = this._transforms[t.tag()][e.tag()](t, e), u = function() {
                    switch (e.tag()) {
                        case "P":
                            return e.value;
                        case "D":
            ...
            if (Z.is_number(t)) {
                if (null != t[te.INT64_TAG]) return te.validateInt64(t), {
                    I: t[te.INT64_TAG]
                };
            ...
            if (Z.is_date(t)) return r = Math.round(t.getTime()), {
                T: "" + r
            };
            if (Z.isUint8Array(t)) return {
                B: te.base64StringFromUint8Array(t)
            };
            ...
            return t.prototype.datastoreListChanged = null, t.prototype.close = function() {
                ...
                return t = this._lastListDsServerResponse || new k({
                    datastores: [],
                    token: "dummy"
                }), this.datastoreListChanged.dispatch(new S.Datastore.DatastoreListChanged(this._getOverlaidDatastoreInfosFromListResponse(t))), void 0
            ...
            return t.prototype.setCredentials = function(t) {
                ...
                return n = {
                    kid: this._tokenKid,
                    ts: S.Util.Oauth.timestamp()
                }, i = t.toUpperCase() + "&" + S.Util.Xhr.urlEncodeValue(e) + "&" + S.Util.Xhr.urlEncodeValue(S.Util.Xhr.urlEncode(r)), n.mac = S.Util.hmac(i, this._tokenKey), n
            }, t.prototype.appHash = function() {
    ...
    S.Util.Xhr = function() {
            ...
            return t.Request = y, t.ieXdr = g, t.canSendForms = p, t.doesPreflight = f, t.ArrayBufferView = _, t.sendArrayBufferView = m, t.wrapBlob = v, t.prototype.xhr = null, t.prototype.onError = null, t.prototype.setParams = function(t) {
                ...
                if (this.wantHeaders ? (t = this.xhr.getAllResponseHeaders(), s = t ? S.Util.Xhr.parseResponseHeaders(t) : this.guessResponseHeaders(), h = s["x-dropbox-metadata"]) : (s = void 0, h = this.xhr.getResponseHeader("x-dropbox-metadata")), null != h ? h.length : void 0) try {
                    l = JSON.parse(h)
                } catch (f) {
                    if (u = f, o = h.search(/\}\,\s*\{/), -1 !== o) try {
